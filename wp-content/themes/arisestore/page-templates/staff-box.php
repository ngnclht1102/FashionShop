...
?>
<!-- Start staff-box -->
<div id="main-content" class="main-content staff-page staff-box <?php echo esc_attr(tm_sidebar_position()); ?>">
      ...
      <div id="container" class="staff-box-container box-container">
        <?php	
		   wp_reset_postdata();  // Reset
			...
			$last_class = "";
				$staff_args = array(
					'posts_per_page' 	=> arise_staff_box_posts_per_page(), 
					'paged' 			=> $paged,
					'post_type'			=> 'staff',
					'status'			=> 'publish',
				);
				...
				$columns_number = arise_staff_box_columns_number();	
				if ( $wp_query->have_posts() ): ?>
        <div class="grid <?php echo esc_attr(arise_staff_box_columns_class()); ?>">
          <?php 
				$i = 1;
          ...
          <div class="grid-item item <?php echo esc_attr($last_class); ?>">
            <?php 
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
              ...
              <div class="entry-content">
                <div class="staff-image">
                  <?php arise_print_images_thumb($post_image, get_the_title(get_the_ID()), 500, 500, 'left'); ?>
                </div>
                ...
                <div class="staff-social icon-<?php echo esc_attr($s);?>">
                  <?php
					 if(!empty($staff_link)) :  ?>
                  <a href="<?php echo esc_url($staff_link); ?>" title="<?php echo __('Website', 'arise');?>" class="website icon"><i class="fa fa-link"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_email)) :  ?>
                  <a href="<?php echo esc_url($staff_email); ?>" title="<?php echo __('Email', 'arise');?>" class="email icon"><i class="fa fa-envelope-o"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_twitter)) :  ?>
                  <a href="<?php echo esc_url($staff_twitter); ?>" title="<?php echo __('Twitter', 'arise');?>" class="twitter icon"><i class="fa fa-twitter"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_facebook)) :  ?>
                  <a href="<?php echo esc_url($staff_facebook); ?>" title="<?php echo __('Facebook', 'arise');?>" class="facebook icon"><i class="fa fa-facebook"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_google_plus)) :  ?>
                  <a href="<?php echo esc_url($staff_google_plus); ?>" title="<?php echo __('Google Plus', 'arise');?>" class="google-plus icon"><i class="fa fa-google-plus"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_linkedin)) :  ?>
                  <a href="<?php echo esc_url($staff_linkedin); ?>" title="<?php echo __('Linkedin', 'arise');?>" class="linkedin icon"><i class="fa fa-linkedin"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_youtube)) :  ?>
                  <a href="<?php echo esc_url($staff_youtube); ?>" title="<?php echo __('Youtube', 'arise');?>" class="youtube icon"><i class="fa fa-youtube"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_rss)) :  ?>
                  <a href="<?php echo esc_url($staff_rss); ?>" title="<?php echo __('RSS', 'arise');?>" class="rss icon"><i class="fa fa-rss"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_pinterest)) :  ?>
                  <a href="<?php echo esc_url($staff_pinterest); ?>" title="<?php echo __('Pinterest', 'arise');?>" class="pinterest icon"><i class="fa fa-pinterest"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_skype)) :  ?>
                  <a href="<?php echo esc_url($staff_skype); ?>" title="<?php echo __('Skype', 'arise');?>" class="skype icon"><i class="fa fa-skype"></i></a>
                  <?php endif; ?>
                </div>
              </div>
            </article>
