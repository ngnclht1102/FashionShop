...
<div id="main-content" class="main-content testimonial-page testimonial-box <?php echo esc_attr(tm_sidebar_position()); ?>">
      ...
      <div id="container" class="testimonial-box-container box-container">
        <?php	
			...
			$last_class = "";
				...
				$columns_number = arise_testimonial_box_columns_number();	
				if ( $wp_query->have_posts() ): ?>
        <div class="loading"> <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/loading.gif" alt="" /> </div>
        <div class="masonry <?php echo esc_attr(arise_testimonial_box_columns_class()); ?>">
          ...
          <div class="masonry-item item <?php echo esc_attr($last_class); ?>">
            <?php 
