...
$TM_META_BOXES[] = array(
	...
	'title' 	=> __('TM - Short Description', 'arise'),
	'pages' 	=> array( 'post' ),
	'context' 	=> 'side',
	'priority' 	=> 'low',
	'local_images' => true,
...
$TM_META_BOXES[] = array(
	'id'		=> 'tm_posts_options',
	'title' 	=> __('TM - Post Options', 'arise'),
	'pages' 	=> array( 'post' ),
	'context' 	=> 'side',
	'priority' 	=> 'low',
	'local_images' => true,
	'fields' 	=> array(
		...
		array(
			'name'    		=> __('Show Related Posts on single post:', 'arise'),
		...
		array(
			'name'    		=> __('Show Author Info on single post:', 'arise'),
...
$TM_META_BOXES[] = array(
	...
	'title' 	=> __('TM - List Options', 'arise'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'side',
	'priority' 	=> 'low',
	'local_images' => true,
	'fields' 	=> array(	
		...
		array(
			'name'			=> __('Number of posts per page:', 'arise'),
...
$TM_META_BOXES[] = array(
	...
	'title' 	=> __('TM - Filter Options', 'arise'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'side',
	'priority' 	=> 'low',
	'local_images' => true,
