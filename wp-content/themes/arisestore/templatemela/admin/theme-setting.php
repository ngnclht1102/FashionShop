...
$options1[] = array("id" => "tmoption_button_opacity",
					"label" => "Button backgound opacity",
					"type" => "textbox",
					"std" => "1 ",
...
$options1[] = array("id" => "tmoption_button_hover_opacity",
					"label" => "Button hover backgound opacity",
					"type" => "textbox",
					"std" => "1",
...
$options3[] = array("id" => "tmoption_h2font",
					...
					"options" => array('Montserrat'=>'Montserrat','Open+Sans'=>'Open Sans','please-select'=>'please-select','Roboto Slab'=>'Roboto Slab','Nunito'=>'Nunito','Droid+Sans'=>'Droid Sans','Antic'=>'Antic','Bitter'=>'Bitter','Droid+Serif'=>'Droid Serif','Philosopher'=>'Philosopher','Oxygen'=>'Oxygen','Rokkitt'=>'Rokkitt','Galdeano'=>'Galdeano','Glegoo'=>'Glegoo','Oswald'=>'Oswald','Play'=>'Play','Cuprum'=>'Cuprum','Varela'=>'Varela','Andika'=>'Andika','Raleway'=>'Raleway','Other+Fonts'=>'Other Fonts'));
...
$options4[] = array("id" => "tmoption_footer_bkg_opacity",
					"label" => "Footer Background Color Opacity",
					"type" => "textbox",
					"std" => "0.6",
					"description" => "Change your footer background color opacity.");
...
$options6[] = array("id" => "tmoption_topbar_bkg_color_opacity",
					"label" => "Top Bar Background opacity",
					"type" => "textbox",
					"std" => "1 ",
...
$options6[] = array("id" => "tmoption_top_menu_opacity",
					"label" => "Top Menu backgound color opacity",
					"type" => "textbox",
					"std" => "0.0",
					"description" => "Change your background color opacity of your top menu");		
...
$options6[] = array("label" => "Top Bar Social Links Setting",
					"title" =>"Top Bar Social Links Setting",
					"type" => "Title-1");
...
$options6[] = array("id" => "tmoption_topbar_instagram",
					...
					"std" => "",
					"type" => "textbox",
					"description" => "Change your topbar instagram.");												
//=============================================== Shop Settings ==================================================================
...
$options8[] = array("id" => "tmoption_slider_type",
          			"label" => "Select slider type single or Double",
         			"type" => "select",
          			"description" => "Select slider type single or Double.",
...
<div id="tab-container" class='tab-container'>
  <ul class='etabs'>
    ...
    <li class="tab"> <a href="#shop"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/shop_setting.png" alt="blog"/> <span class="title">
      <?php echo __('Shop','arise');?>
      </span></a> </li>
	  <?php endif; ?>
	<li class="tab"> <a href="#slider"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/footer_settings.png" alt="blog"/> <span class="title"> <?php echo __('Slider','arise');?> </span></a> </li>  
  </ul>
  ...
  <div class='panel-container'>
	 ...
	 if(!isset( $_REQUEST['reset1'])) {$_REQUEST['reset1']=''; }
       if ( 'save_options1' == $_REQUEST['action'] )
       {
        ...
        <div class="background-title">
          <label>
          <?php echo __('General Settings', 'arise'); ?>
          </label>
        </div>
        <?php
       $i= 0;
	...
	case 'upload-1': ?>
        ...
        <div class="even setting_main">
          ...
          <div class="title">
            ...
            <img src="<?php echo esc_url(get_option('tmoption_favicon_icon'));?>" id="slider_favicondisplay"/>&nbsp;<a id="slider_remove_link2" href="javascript:removeImage2();"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/remove.png" /></a>
            <?php }	?>
            <script>
    ...
    ?>
        ...
        <div class="background-title">
          <label>
          <?php echo __('Top header Settings', 'arise'); ?>
          </label>
        </div>
        <?php
     foreach ($options6 as $value) { 
...
<?php if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) : ?>
	...
	if(!isset( $_REQUEST['reset7'])) {$_REQUEST['reset7']=''; }	
     ...
     ?>
        ...
        <div class="background-title">
         <label>
            <?php echo __('Shop Settings', 'arise'); ?>
          </label>
        </div>
        <?php
        foreach ($options7 as $value) { 
   ...
   ?>
	...
	if(!isset( $_REQUEST['reset8'])) {$_REQUEST['reset8']=''; }	
     ...
     ?>
        <div class="form-table">
        <div class="background-title">
          <label> <?php echo __('Slider Settings', 'arise'); ?> </label>
        </div>
        <?php
        foreach ($options8 as $value) { 
if(!isset( $value['type'])) {$value['type']=''; }	
   ...
   ?>
    ...
    ?>
        ...
        <div class="background-title">
			<label>
          <?php echo __('Header Settings', 'arise'); ?>
		  	</label>
        </div>
        <?php
     foreach ($options2 as $value) { 
...
window.onload=function(){
    ...
    <div id="Content">
     ...
     ?>
        ...
        <div class="background-title">
          <label>
          <?php echo __('Content Settings', 'arise'); ?>
          </label>
        </div>
        <?php
        foreach ($options3 as $value) { 
   ...
   ?>
    ...
    ?>
        ...
        <div class="background-title">
          <label>
          <?php echo __('Footer Settings', 'arise'); ?>
          </label>
        </div>
        <?php
     foreach ($options4 as $value) { 
