...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  ...
  <?php endif; ?>
	...
	<?php if(is_single()): ?>
		<div class="entry-content-inner"> 
	 <div class="entry-meta-inner">
		<div class="entry-meta"> <span class="post-format"> <a class="entry-format" href="<?php echo esc_url( get_post_format_link( 'quote' ) ); ?>"><?php echo esc_attr(get_post_format_string( 'quote' )); ?></a> </span>
			 	<?php if (is_single()):
