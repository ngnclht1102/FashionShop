...
<header id="masthead" class="site-header<?php echo " header".esc_attr(get_option('tmoption_header_layout')); ?> <?php echo esc_attr(tm_sidebar_position()); ?> main" role="banner">
				...
				<div class="header_center">
				  ...
				  <div id="navbar" class="header-bottom navbar default">
										<nav id="site-navigation" class="navigation main-navigation" role="navigation">									
											<h3 class="menu-toggle"><?php _e( 'Menu', 'fashion3' ); ?></h3>
											<a class="screen-reader-text skip-link" href="#content" title="<?php esc_attr_e( 'Skip to content', 'fashion3' ); ?>"><?php _e( 'Skip to content', 'fashion3' ); ?></a>	
											<div class="mega-menu">
				...
				<div class="inner-left">
					...
					<div class="header_cart headercart-block">
								<?php 
									...
									ob_start();?>						
									<div id="shopping_cart" class="shopping_cart tog" <?php /*?>href="<?php echo $woocommerce->cart->get_cart_url(); ?>"<?php */?> title="<?php _e('View your shopping cart', 'fashion3'); ?>">
									
									<a class="cart-contents" href="<?php echo esc_url($woocommerce->cart->get_cart_url()); ?>" title="<?php _e('View your shopping cart', 'fashion3'); ?>"><?php echo sprintf(_n('%d', '%d', $woocommerce->cart->cart_contents_count, 'fashion3'), $woocommerce->cart->cart_contents_count);?><?php //echo esc_attr($woocommerce->cart->get_cart_total()); ?></a>
									</div>	
									<?php global $woocommerce; ?>
						...
						<?php if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) : ?>
							<div class="header_login"><!-- Start header cart -->
								<div class="header_logout">					
									...
									<?php echo _e('Myaccount','fashion3'); ?></a></div>
								    <div class="my_logout"><a href="<?php echo $logout_url; ?>" class="logout"><?php echo _e('Logout','fashion3'); ?></a></div>
									<?php }
									else { ?>
									<div class="my_login"><a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" class="login show-login-link" id="show-login-link" ><?php echo _e('Login/Register','fashion3'); ?></a></div>
									<?php } ?>   
								</div>
							</div>		
						<?php endif; ?>		
